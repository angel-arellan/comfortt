...
//             cy.intercept('POST', '/checkout').as('checkoutRequest'); // Intercepta la solicitud de checkout
//             cy.get('#checkout_button-checkout_button_1 > form > button').click();
//             cy.wait('@checkoutRequest'); // Espera que se haga la solicitud
//             cy.url().should('include', '/checkout'); // Verifica que se haya redirigido*/
...
//     cy.url().should('include', 'https://comfrt.com/checkouts/cn');
...
// //Revisar el checkout+ cómo bloquear pop up 
